function [x_est, lambda_est, time_tot] = LSM_onestep_filter(varargin)

% [x_est, lambda_est, time_tot] = LSM_onestep_filter(y_meas, G_n, F_n, ...
...
% 
% This function takes the set of measutements y over time and causally
...
%              x[t] <-- armin{ ||y[t] - G[t]*x||_2^2 + tau*|L*x||_1
% where L = diag(lambda[t]). This code assumes x is cannonically sparse. If
